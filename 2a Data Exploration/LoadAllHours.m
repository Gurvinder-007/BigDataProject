function [LoadAllHoursMem] = LoadAllHours(FileName)
...
for StartHour = 1:25
    ...
    LoadAllHoursMem = max( [ HourMem, whos('HourlyData').bytes/1000000 ] );
    fprintf('Loaded Hour %i, memory used: %.3f MB\n', StartHour, LoadAllHoursMem); % display loading information
end
